...
class YOLOV2Head(BaseDenseHead, BBoxTestMixin):
    ...
    def _init_layers(self):
        ...
        # self.convs_pred = nn.Conv2d(self.out_channels[0],
    ...
    def forward(self, feats):
        ...
        pred_maps = []
        # pred_map = self.convs_pred(feats)
        # pred_maps.append(pred_map)
        for i in range(self.num_levels):
            pred_map = self.convs_pred[i](feats)
            pred_maps.append(pred_map)
